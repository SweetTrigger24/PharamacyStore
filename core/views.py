...
def dashboard(request):
    ...
    prescription_revenue_table = (
        OrderItem.objects
        .filter(product__medicine_type='prescription')
        .exclude(order__status='cancelled')
        .values('product__proid', 'product__name')
        .annotate(
    ...
    return render(request, 'admin_panel/index.html', {
        ...
        'prescription_revenue_table': prescription_revenue_table,
