...
urlpatterns = [
    ...
    path('he-thong-nha-thuoc/', views.hethongnhathuoc, name='hethongnhathuoc'),
    path('gop-y/', views.gopy, name='gopy'),
    path('hanh-trinh-10-nam/', views.hanhtrinh10nam, name='hanhtrinh10nam'),
    path('dia-chi-cham-soc-suc-khoe/', views.diachichamsocsuckhoe, name='diachichamsocsuckhoe'),
    path('tu-nhan-vien-it/', views.tunhanvienit, name='tunhanvienit'),
    path('chinh-sach-bao-mat/', views.chinhsachbaomat, name='chinhsachbaomat'),
    path('chinh-sach-noi-dung/', views.chinhsachnoidung, name='chinhsachnoidung'),
    path('chinh-sach-thanh-toan/', views.chinhsachthanhtoan, name='chinhsachthanhtoan'),
    path('giay-phep-kinh-doanh/', views.giayphepkinhdoanh, name='giayphepkinhdoanh'),
    path('quy-che-hoat-dong/', views.quychehoatdong, name='quychehoatdong'),
